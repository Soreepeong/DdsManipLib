...
public sealed class B8G8R8X8UNormSrgbPixelFormat : B8G8R8X8PixelFormat, IRawRgbPixelFormat<byte> {
    public override DxgiFormat DxgiFormat => DxgiFormat.B8G8R8X8UNormSrgb;
