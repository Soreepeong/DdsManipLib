...
public sealed class R8G8B8A8TypelessPixelFormat : R8G8B8A8PixelFormat, IRawRgbaPixelFormat<byte>, IRawRgbaPixelFormat<sbyte> {
    public override DxgiFormat DxgiFormat => DxgiFormat.R8G8B8A8Typeless;
    ...
    public R8G8B8A8TypelessPixelFormat(AlphaType alphaType) : base(alphaType) { }
}
