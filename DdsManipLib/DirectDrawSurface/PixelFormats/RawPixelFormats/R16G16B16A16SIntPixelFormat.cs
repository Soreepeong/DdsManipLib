...
public sealed class R16G16B16A16SIntPixelFormat : R16G16B16A16PixelFormat, IRawRgbPixelFormat<short>, IRawAPixelFormat<short> {
    ...
    public override void SetBlue(Span<byte> pixel, float value) => SetBlue(pixel, short.CreateSaturating(value));
    public override void SetAlpha(Span<byte> pixel, float value) => SetAlpha(pixel, short.CreateSaturating(value));
    ...
    public R16G16B16A16SIntPixelFormat(AlphaType alphaType) : base(alphaType) { }
}
