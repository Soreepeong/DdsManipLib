...
public sealed class DdspfRxGxBxAxUNormPixelFormat<T> : DdspfUNormPixelFormat, IRawRgbaPixelFormat<T>
    ...
    internal DdspfRxGxBxAxUNormPixelFormat(int nbits, int rshift, int rbits, int gshift, int gbits, int bshift, int bbits, int ashift, int abits) : base(nbits, rshift, rbits, gshift, gbits, bshift, bbits, ashift, abits) { }
