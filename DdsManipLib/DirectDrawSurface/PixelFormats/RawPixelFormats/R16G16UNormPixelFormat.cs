...
public sealed class R16G16UNormPixelFormat : R16G16PixelFormat, IRawRgPixelFormat<ushort> {
    public override DdsFourCc FourCc => DdsFourCc.D3dFmtG16R16;
    ...
    public override void SetGreen(Span<byte> pixel, float value) => SetGreen(pixel, ushort.CreateSaturating(value * 65536f));
