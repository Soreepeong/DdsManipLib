...
public sealed class R8G8B8A8SIntPixelFormat : R8G8B8A8PixelFormat, IRawRgbaPixelFormat<sbyte> {
    ...
    public override void SetBlue(Span<byte> pixel, float value) => pixel[OffsetB] = (byte) sbyte.CreateSaturating(value);
    public override void SetAlpha(Span<byte> pixel, float value) => pixel[OffsetA] = (byte) sbyte.CreateSaturating(value);
    ...
    public R8G8B8A8SIntPixelFormat(AlphaType alphaType) : base(alphaType) { }
}
