...
public sealed class R16G16SNormPixelFormat : R16G16PixelFormat, IRawRgPixelFormat<short> {
    ...
    public override void SetRed(Span<byte> pixel, float value) => SetRed(pixel, short.CreateTruncating(Math.Clamp(value, -1f, 1f) * 32767f));
    public override void SetGreen(Span<byte> pixel, float value) => SetGreen(pixel, short.CreateTruncating(Math.Clamp(value, -1f, 1f) * 32767f));
