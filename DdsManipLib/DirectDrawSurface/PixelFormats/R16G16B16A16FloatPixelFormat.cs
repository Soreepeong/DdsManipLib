...
public sealed class R16G16B16A16FloatPixelFormat : R16G16B16A16PixelFormat, IRawRgbPixelFormat<Half>, IRawAlphaPixelFormat<Half> {
    ...
    public override void SetRed(Span<byte> pixel, float value) => SetRed(pixel, Half.CreateTruncating(65536 * value));
    public override void SetGreen(Span<byte> pixel, float value) => SetGreen(pixel, Half.CreateTruncating(65536 * value));
    public override void SetBlue(Span<byte> pixel, float value) => SetBlue(pixel, Half.CreateTruncating(65536 * value));
    public override void SetAlpha(Span<byte> pixel, float value) => SetAlpha(pixel, Half.CreateTruncating(65536 * value));
