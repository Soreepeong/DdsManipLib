...
/// <summary>
/// Maps across different representations of pixel formats.
/// </summary>
public static class PixelFormatResolver {
    ...
    static PixelFormatResolver() {
        ...
        DxgiFormatToPixelFormat = new Dictionary<AlphaType, IReadOnlyDictionary<DxgiFormat, PixelFormat>> {
            {
                AlphaType.None, new Dictionary<DxgiFormat, PixelFormat> {
                    {DxgiFormat.R32G32B32Typeless, RgbaPixelFormat.NewRgb(32, 32, 32, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R32G32B32Float, RgbaPixelFormat.NewRgb(32, 32, 32, 0, 0, ChannelType.F32)},
                    {DxgiFormat.R32G32B32Uint, RgbaPixelFormat.NewRgb(32, 32, 32, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R32G32B32Sint, RgbaPixelFormat.NewRgb(32, 32, 32, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.R32G32Float, RgbaPixelFormat.NewRg(32, 32, 0, 0, ChannelType.F32)},
                    {DxgiFormat.R32G32Uint, RgbaPixelFormat.NewRg(32, 32, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R32G32Sint, RgbaPixelFormat.NewRg(32, 32, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.R16G16Typeless, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R16G16Float, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.F16)},
                    {DxgiFormat.R16G16Unorm, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Unorm)},
                    {DxgiFormat.R16G16Uint, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R16G16Snorm, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Snorm)},
                    {DxgiFormat.R16G16Sint, RgbaPixelFormat.NewRg(16, 16, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.R32Typeless, RgbaPixelFormat.NewR(32, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R32Float, RgbaPixelFormat.NewR(32, 0, 0, ChannelType.F32)},
                    {DxgiFormat.R32Uint, RgbaPixelFormat.NewR(32, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R32Sint, RgbaPixelFormat.NewR(32, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.R24G8Typeless, RgbaPixelFormat.NewRg(24, 8, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R8G8Typeless, RgbaPixelFormat.NewRg(8, 8, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R8G8Unorm, RgbaPixelFormat.NewRg(8, 8, 0, 0, ChannelType.Unorm)},
                    {DxgiFormat.R8G8Uint, RgbaPixelFormat.NewRg(8, 8, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R8G8Snorm, RgbaPixelFormat.NewRg(8, 8, 0, 0, ChannelType.Snorm)},
                    {DxgiFormat.R8G8Sint, RgbaPixelFormat.NewRg(8, 8, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.R16Typeless, RgbaPixelFormat.NewR(16, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R16Float, RgbaPixelFormat.NewR(16, 0, 0, ChannelType.F16)},
                    {DxgiFormat.R16Unorm, RgbaPixelFormat.NewR(16, 0, 0, ChannelType.Unorm)},
                    {DxgiFormat.R16Uint, RgbaPixelFormat.NewR(16, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R16Snorm, RgbaPixelFormat.NewR(16, 0, 0, ChannelType.Snorm)},
                    {DxgiFormat.R16Sint, RgbaPixelFormat.NewR(16, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.R8Typeless, RgbaPixelFormat.NewR(8, 0, 0, ChannelType.Typeless)},
                    {DxgiFormat.R8Unorm, RgbaPixelFormat.NewR(8, 0, 0, ChannelType.Unorm)},
                    {DxgiFormat.R8Uint, RgbaPixelFormat.NewR(8, 0, 0, ChannelType.Uint)},
                    {DxgiFormat.R8Snorm, RgbaPixelFormat.NewR(8, 0, 0, ChannelType.Snorm)},
                    {DxgiFormat.R8Sint, RgbaPixelFormat.NewR(8, 0, 0, ChannelType.Sint)},
                    {DxgiFormat.B5G6R5Unorm, RgbaPixelFormat.NewBgr(5, 6, 5, 0, 0, ChannelType.Unorm)},
                ...
                AlphaType.Straight, new Dictionary<DxgiFormat, PixelFormat> {
                    {DxgiFormat.R32G32B32A32Typeless, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Typeless, AlphaType.Straight)},
                    {DxgiFormat.R32G32B32A32Float, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.F32, AlphaType.Straight)},
                    {DxgiFormat.R32G32B32A32Uint, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Uint, AlphaType.Straight)},
                    {DxgiFormat.R32G32B32A32Sint, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Sint, AlphaType.Straight)},
                    {DxgiFormat.R16G16B16A16Typeless, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Typeless, AlphaType.Straight)},
                    {DxgiFormat.R16G16B16A16Float, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.F16, AlphaType.Straight)},
                    {DxgiFormat.R16G16B16A16Unorm, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                    {DxgiFormat.R16G16B16A16Uint, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Uint, AlphaType.Straight)},
                    {DxgiFormat.R16G16B16A16Snorm, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Snorm, AlphaType.Straight)},
                    {DxgiFormat.R16G16B16A16Sint, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Sint, AlphaType.Straight)},
                    {DxgiFormat.R10G10B10A2Typeless, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Typeless, AlphaType.Straight)},
                    {DxgiFormat.R10G10B10A2Unorm, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                    {DxgiFormat.R10G10B10A2Uint, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Uint, AlphaType.Straight)},
                    {DxgiFormat.R8G8B8A8Typeless, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Typeless, AlphaType.Straight)},
                    {DxgiFormat.R8G8B8A8Unorm, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                    {DxgiFormat.R8G8B8A8UnormSrgb, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.UnormSrgb, AlphaType.Straight)},
                    {DxgiFormat.R8G8B8A8Uint, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Uint, AlphaType.Straight)},
                    {DxgiFormat.R8G8B8A8Snorm, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Snorm, AlphaType.Straight)},
                    {DxgiFormat.R8G8B8A8Sint, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Sint, AlphaType.Straight)},
                    {DxgiFormat.A8Unorm, RgbaPixelFormat.NewA(8, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                    {DxgiFormat.B5G5R5A1Unorm, RgbaPixelFormat.NewBgra(5, 5, 5, 1, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                    {DxgiFormat.B8G8R8A8Unorm, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                    {DxgiFormat.B8G8R8A8Typeless, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.Typeless, AlphaType.Straight)},
                    {DxgiFormat.B8G8R8A8UnormSrgb, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.UnormSrgb, AlphaType.Straight)},
                    {DxgiFormat.B4G4R4A4Unorm, RgbaPixelFormat.NewBgra(4, 4, 4, 4, 0, 0, ChannelType.Unorm, AlphaType.Straight)},
                ...
                AlphaType.Premultiplied, new Dictionary<DxgiFormat, PixelFormat> {
                    {DxgiFormat.R32G32B32A32Typeless, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Typeless, AlphaType.Premultiplied)},
                    {DxgiFormat.R32G32B32A32Float, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.F32, AlphaType.Premultiplied)},
                    {DxgiFormat.R32G32B32A32Uint, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Uint, AlphaType.Premultiplied)},
                    {DxgiFormat.R32G32B32A32Sint, RgbaPixelFormat.NewRgba(32, 32, 32, 32, 0, 0, ChannelType.Sint, AlphaType.Premultiplied)},
                    {DxgiFormat.R16G16B16A16Typeless, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Typeless, AlphaType.Premultiplied)},
                    {DxgiFormat.R16G16B16A16Float, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.F16, AlphaType.Premultiplied)},
                    {DxgiFormat.R16G16B16A16Unorm, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                    {DxgiFormat.R16G16B16A16Uint, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Uint, AlphaType.Premultiplied)},
                    {DxgiFormat.R16G16B16A16Snorm, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Snorm, AlphaType.Premultiplied)},
                    {DxgiFormat.R16G16B16A16Sint, RgbaPixelFormat.NewRgba(16, 16, 16, 16, 0, 0, ChannelType.Sint, AlphaType.Premultiplied)},
                    {DxgiFormat.R10G10B10A2Typeless, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Typeless, AlphaType.Premultiplied)},
                    {DxgiFormat.R10G10B10A2Unorm, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                    {DxgiFormat.R10G10B10A2Uint, RgbaPixelFormat.NewRgba(10, 10, 10, 2, 0, 0, ChannelType.Uint, AlphaType.Premultiplied)},
                    {DxgiFormat.R8G8B8A8Typeless, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Typeless, AlphaType.Premultiplied)},
                    {DxgiFormat.R8G8B8A8Unorm, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                    {DxgiFormat.R8G8B8A8UnormSrgb, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.UnormSrgb, AlphaType.Premultiplied)},
                    {DxgiFormat.R8G8B8A8Uint, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Uint, AlphaType.Premultiplied)},
                    {DxgiFormat.R8G8B8A8Snorm, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Snorm, AlphaType.Premultiplied)},
                    {DxgiFormat.R8G8B8A8Sint, RgbaPixelFormat.NewRgba(8, 8, 8, 8, 0, 0, ChannelType.Sint, AlphaType.Premultiplied)},
                    {DxgiFormat.A8Unorm, RgbaPixelFormat.NewA(8, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                    {DxgiFormat.B5G5R5A1Unorm, RgbaPixelFormat.NewBgra(5, 5, 5, 1, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                    {DxgiFormat.B8G8R8A8Unorm, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                    {DxgiFormat.B8G8R8A8Typeless, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.Typeless, AlphaType.Premultiplied)},
                    {DxgiFormat.B8G8R8A8UnormSrgb, RgbaPixelFormat.NewBgra(8, 8, 8, 8, 0, 0, ChannelType.UnormSrgb, AlphaType.Premultiplied)},
                    {DxgiFormat.B4G4R4A4Unorm, RgbaPixelFormat.NewBgra(4, 4, 4, 4, 0, 0, ChannelType.Unorm, AlphaType.Premultiplied)},
                ...
                AlphaType.Custom, new Dictionary<DxgiFormat, PixelFormat> {
                    {DxgiFormat.B8G8R8X8Unorm, RgbaPixelFormat.NewBgr(8, 8, 8, 8, 0, ChannelType.Unorm)},
                    {DxgiFormat.B8G8R8X8Typeless, RgbaPixelFormat.NewBgr(8, 8, 8, 8, 0, ChannelType.Typeless)},
                    {DxgiFormat.B8G8R8X8UnormSrgb, RgbaPixelFormat.NewBgr(8, 8, 8, 8, 0, ChannelType.UnormSrgb)},
    ...
    /// <summary>
    /// Get the corresponding pixel format for the given FourCc.
    /// </summary>
    public static PixelFormat ToPixelFormat(this DdsFourCc fourCc) =>
        FourCcToPixelFormat.TryGetValue(fourCc, out var v) ? v : UnknownPixelFormat.Instance;

    /// <summary>
    /// Get the corresponding pixel format for the given alpha type and DXGI format.
    /// </summary>
    public static PixelFormat ToPixelFormat(this DxgiFormat dxgiFormat, AlphaType alphaType) =>
    ...
    /// <summary>
    /// Get the corresponding FourCc for the given pixel format.
    /// </summary>
    public static DdsFourCc ToFourCc(this PixelFormat pf) =>
        FourCcToPixelFormat.FirstOrDefault(x => Equals(x.Value, pf)).Key;

    /// <summary>
    /// Get the corresponding DXGI format for the given pixel format.
    /// </summary>
    public static DxgiFormat ToDxgiFormat(this PixelFormat pf) =>
