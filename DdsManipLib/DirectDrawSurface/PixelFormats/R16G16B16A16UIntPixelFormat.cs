...
public sealed class R16G16B16A16UIntPixelFormat : R16G16B16A16PixelFormat, IRawRgbPixelFormat<ushort>, IRawAlphaPixelFormat<ushort> {
    ...
    public override void SetGreen(Span<byte> pixel, float value) => SetGreen(pixel, ushort.CreateTruncating(value));
    public override void SetBlue(Span<byte> pixel, float value) => SetBlue(pixel, ushort.CreateTruncating(value));
    public override void SetAlpha(Span<byte> pixel, float value) => SetAlpha(pixel, ushort.CreateTruncating(value));
